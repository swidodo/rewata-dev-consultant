            ...
            <form action="{{route('profile.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row px-5">
                    <div class="form-group mb-3">
                        <label>Nama</label>
                        <textarea name="name" class="form-control" rows="10" id="summername"></textarea>
                    </div>
                    <div class="form-group mb-3">
                        <label>Sepesialis</label>
                        <textarea name="spesialis" class="form-control" rows="10" id="summerspecial"></textarea>
                    </div>
                    <div class="form-group mb-3">
                        <label>Pendidikan</label>
                        <textarea name="education" class="form-control" rows="10" id="summereducation"></textarea>
                    </div>
                    <div class="form-group mb-3">
                        <label>Keahlian</label>
                        <textarea name="skill" class="form-control" rows="10" id="summerskill"></textarea>
                    </div>
                    <div class="form-group mb-3">
                        <label>Pengalaman</label>
                        <textarea name="experience" class="form-control" rows="10" id="summerexperiance"></textarea>
                    </div>
