    ...
    <div class="mt-5 card">
        ...
        <div class="card-body border border-danger">
            <div class="table-responsive">
                @if(isset($tentang))
                    <a href="/tentang-edit" class="btn btn-primary mb-1 float-end">Edit</a>
                @else
                    <a href="/tentang-create" class="btn btn-primary mb-1 float-end">Create</a>
                @endif
                @if(isset($tentang))
                    <h3>Judul</h3>
                    <h4>{{$tentang->judul}}</h4>
                    <h3>Layanan Jasa</h3>
                    <h4>{!! $tentang->short_deskripsi !!}</h4>
                    <h3>Deskripsi</h3>
