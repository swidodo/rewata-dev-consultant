...
<section class="mt-5">
    ...
    <div class="mt-5 card">
        ...
        <div class="card-body border border-danger">
            <form action="{{route('poin-managemen-sdm-store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row px-5">
                    ...
                    <div class="form-group mb-3">
                        <label>Judul</label>
                        <textarea name="judul" class="form-control" rows="3" id="summertitle"></textarea>
                    </div>
                    <div class="form-group mb-3">
                        <label>Deskripsi</label>
                        <textarea name="deskripsi" class="form-control" rows="10" id="summerbody"></textarea>
                    </div>
