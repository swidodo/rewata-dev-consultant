        ...
        <div class="card-body border border-danger">
            <form action="{{ route('layanan-perusahaan.update', $layanan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row px-5">
                    ...
                    <div class="col-md-6">
                        <img id="img-show" src="{{asset('storage/layanan/perusahaan/'.basename($layanan->image))}}" style="margin-top: 25px; min-width: 30px; min-height : 30px; max-width : 100%;max-height:150;">
                    </div>
                </div>
            </form>
        </div>
