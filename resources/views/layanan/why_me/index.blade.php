    ...
    <div class="mt-5 card">
        ...
        <div class="card-body border border-danger">
            <div class="table-responsive">
                <a href="/why-me/create" class="btn btn-primary mb-1 float-end">Create</a>
                        ...
                        <tr id="{{$ly->id}}">
                            ...
                            <td width="150">
                                <a href="{{$ly->image}}" target="_blank">
                                    <img src="{{asset('storage/layanan/why_me/'.basename($ly->image))}}" class="img-fluid">
                                </a>
                            </td>
                            <td>{{ $ly->created_by }}</td>
                            <td>{{ $ly->created_at }}</td>
                            ...
                            <td class="text-center">
                                <a href="/why-me/{{$ly->id}}/edit" class="btn btn-primary" title="Edit"><span class="fa fa-edit"></span></a>
