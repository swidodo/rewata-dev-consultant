    ...
    <div class="mt-5 card">
        ...
        <div class="card-body border border-danger">
            <div class="table-responsive">
                <a href="/blog/create" class="btn btn-primary mb-1 float-end">Create</a>
                        ...
                        <tr id="{{$ly->id}}">
                            ...
                            <td width="150">
                                <a href="{{$ly->image}}" target="_blank">
                                    <img src="{{asset('storage/blog/'.$basename)}}" class="img-fluid">
                                </a>
                            </td>
                            ...
                            <td class="text-center">
                                <a href="/blog/{{$ly->id}}/edit" class="btn btn-primary" title="Edit"><span class="fa fa-edit"></span></a>
                                <a href="/blog/{{$ly->id}}" class="btn btn-info" title="Show detail"><span class="fa fa-eye"></span></a>
